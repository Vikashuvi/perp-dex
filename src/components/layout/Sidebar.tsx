...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  return (
    <div className="h-screen w-20 bg-card-darker border-r border-border-dark fixed left-0 top-0 z-40 flex flex-col">
      {/* Logo */}
      ...
      {/* Navigation */}
      <div className="flex-1 flex flex-col items-center pt-8 space-y-8">
        {/* Trade */}
        <button
        ...
        >
          ...
          {/* Hover tooltip */}
          <div className="absolute left-full ml-4 px-2 py-1 bg-card-dark rounded-md text-text-primary text-sm whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 shadow-lg border border-border-dark">
            Trade
          </div>
